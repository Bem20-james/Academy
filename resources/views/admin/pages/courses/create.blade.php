                        ...
                        <form class="px-4 mb-4" action="{{ route('store.course') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="course_name"  placeholder="Course Name" max="400">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-lg-6 col-12 mt-2">
                                    ...
                                    <div class="col-12 col-lg-12 col-md-12">
                                        <select class="form-control parent-category" name="course_category" id="course_cat" required>
                                            ...
                                            @foreach ($category as $return)
                                                <option value="{{ $return->category_name }}">{{ $return->category_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input type="file" class="custom-file-input" name="course_img" aria-describedby="inputGroupFileAddon01">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12 col-12 mt-2">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                            <input class="form-control" id="course_price" class="block mt-1 w-full" type="text" name="course_price" :value="old('course_price')" oninput="this.value=this.value.replace(/[^\d]/g,'')" onchange="this.value=this.value.replace(/[^\d]/g,'')" />
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 d-flex mt-2">
                                        <div class="col-lg-6 col-md-12">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="dropdown">
                                                    <select class="form-control" name="course_type" id="cars" required>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            ...
                                            <select class="form-control" name="course_duration" id="color-one">
                            ...
                            <div class="form-group col-md-12">
                                <div class="form-group col-md-12">
                                    <label for="inputCategoryName4">Course file</label>
                                    <span style="font-size: 11px;"><span style="color: red;">*</span>Note course file must be type of video or E-book</span>
                                    <div class="custom-file">
                                        <label class="custom-file-label" for="inputGroupFile01">choose file</label>
                                        <input type="file" class="custom-file-input" name="course_file" aria-describedby="inputGroupFileAddon01">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="course_status" id="inlineRadio1" value="1">
                                        <label class="form-check-label" for="inlineRadio1">Active</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="course_status" id="inlineRadio2" value="0">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  placeholder="Course Description"  name="course_description" rows="10"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="course-description">Course scope</label>
                                <textarea class="form-control"  placeholder="Course Scope"  name="course_scope" rows="10"></textarea>
                            </div>
