    ...
    <div class="">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">Currency-Edit</li>
                        </ol>
                    </div>
                    </div>
                </div>
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('update.currencies', ['id' =>  $editcurrency->id]) }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="form-group col-md-12 col-12 mt-2">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                            <input class="form-control" id="currency_name" class="block mt-1 w-full" type="text" name="currency_name" value="{{ $editcurrency->currency_name }}" maxlength="25" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-12 mt-2">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                            <input class="form-control" id="currency_code" class="block mt-1 w-full" type="text" name="currency_code" value="{{ $editcurrency->currency_code }}" maxlength="25" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-12 mt-2">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                            <input class="form-control" id="currency_symbol" class="block mt-1 w-full" type="text" name="currency_symbol" value="{{ $editcurrency->currency_symbol }}" maxlength="25" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12 col-12 mt-2">
                                        ...
                                        <div class="col-12 mt-3 mb-3">
                                            <div class="box-footer">
                                                <a href="{{ route('view.languages') }}" type="button" class="btn btn-default float-left"> <i class="fa fa-angle-left"></i> Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
