@extends('admin.layouts.Admin')
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">Languages-View</li>
                    </ol>
                </div>
                </div>
            </div>
    ...
    <div class="mt-3 ml-3">
        <a href="{{ route('view.languages') }}" class="btn btn-success shadow-lg">view Languages</a>
    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 col-12 mt-2">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                            <input class="form-control" id="language_name" class="block mt-1 w-full" type="text" name="language_name" :value="old('language_name')" maxlength="25" required />
                                        </div>
                                    </div>

                                    <div class="form-group  col-md-12 col-12 mt-2">
                                        <div class="col-12 col-lg-12 col-md-12">
                                            <label class="pull-left" for="language_code">Laguage Code</label>
                                        </div>

                                        <div class="col-12 col-lg-12 col-md-12">
                                            <input class="form-control" id="language_code" class="block mt-1 w-full" type="text" name="language_code" :value="old('language_code')" maxlength="25" required />
                                        </div>
                                    </div>
