...
@section('admin_contents')
    ...
    <div class="">
        ...
        <div class="my-5 ml-3">
            <a href="{{ route('view_students') }}" class="btn btn-success shadow-lg">View Students</a>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 ">
                        ...
                        {{-- {{ route('store_students') }} --}}
                        <form class="px-4 mb-4" action="" method="POST">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" class="form-control" name="admission" placeholder="admission number"
                                    max="400">
                                </div>
                            </div>
