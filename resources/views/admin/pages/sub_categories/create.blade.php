@extends('admin.layouts.admin')
    ...
    <div class="">
        ...
        <div class="mt-3 ml-3">
            <a href="{{ route('view.subcategories') }}" class="btn btn-success shadow-lg">View Sub-Categories</a>
        </div>
                        ...
                        <form action="{{ route('store.subcategories') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-row col-12">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <input class="form-control" id="name" class="block mt-1 w-full" type="text" name="subcategory_name" maxlength="75" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <input class="form-control" id="slug" class="block mt-1 w-full" type="text" name="subcategory_slug" maxlength="50" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row col-md-12 col-12 mt-2 ml-1">
                                        <div class="col-md-12">
                                            <div class="col-lg-12 col-md-12">
                                                <label class="pull-left" for="image">Sub-Category Image</label>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <label class="custom-file-label" for="inputGroupFile01">choose file</label>
                                                <input type="file" class="custom-file-input" id="inputGroupFile01" name="subcategory_img" aria-describedby="inputGroupFileAddon01">
                                            </div>
                                        </div>


                                        <div class="col-md-12 mt-2 ml-1 form-row mt-3">
                                            <div class="col-12 col-md-12">
                                            ...
                                            <div class="col-12 col-lg-12 col-md-12">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="subcategory_status" id="inlineRadio1" value="1">
                                                    <label class="form-check-label" for="inlineRadio1">Active</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="subcategory_status" id="inlineRadio2" value="0">
                                    ...
                                    <div class="form-group col-lg-12 col-12 mt-4">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                            <textarea class="form-control" name="subcategory_description" id="" cols="10" rows="5"></textarea>
                                        </div>
                                    </div>
