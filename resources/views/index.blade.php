    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" style="" src="{{ asset('assets/images/peters.jpg') }}" class="images d-block w-100" style="height:500px;"
                    alt="Los Angeles">
            ...
            <div class="carousel-item">
                <img src="{{ asset('assets/images/ladycomputer.jpg') }}" class="images d-block w-100" style="height:500px;"
                    alt="New York">
                <div class="carousel-content">
                    <h1>PROUDLY, ADVANZTEK TO THE WORLD</h1> <br>
                    <h4>AM HAPPY FOR THIS SCHOLARSHIP OFFER</h4>
