<div class="w-100">
    ...
    <div class="top-head pb-0">
        <div class="row w-100 py-0 px-0 d-none d-lg-block">
    ...
    <nav class="navbar navbar-expand-lg navbar-light p-0 m-0 d-flex" style="background-color: #151F4F;">
        <div class="container">
            ...
            <ul class="navbar-nav justify ml-auto homepage-links">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white p-4 mx-2" href="{{ route('contact') }}">Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white p-4 mx-2" href="{{ route('blog') }}">Blog</a>
                </li>
                <li class="nav-item">
